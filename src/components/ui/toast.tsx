...
const toneStyles = {
  success: {
    ...
    action: 'bg-green-700 text-green-50 hover:bg-green-600 focus:ring-green-500',
  },
  error: {
    container: 'bg-red-900/90 border-red-700 text-red-50',
    action: 'bg-red-700 text-red-50 hover:bg-red-600 focus:ring-red-500',
  },
  warning: {
    container: 'bg-yellow-900/90 border-yellow-700 text-yellow-50',
    action: 'bg-yellow-700 text-yellow-50 hover:bg-yellow-600 focus:ring-yellow-500',
  },
  info: {
    container: 'bg-blue-900/90 border-blue-700 text-blue-50',
    action: 'bg-blue-700 text-blue-50 hover:bg-blue-600 focus:ring-blue-500',
  },
} as const;
